-- Test-only schema for isolated repository integration tests.
-- Production installation is defined by db/migrations/0001_v020_baseline.up.sql.
-- Keep this file limited to objects directly required by postgrestest consumers.

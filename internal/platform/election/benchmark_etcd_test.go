...
func TestMain(m *testing.M) {
	...
	var err error
	benchCoord, err = NewEtcd(EtcdConfig{
		Endpoints:   endpoints,
	...
	cleanupKeys = func(prefix string) {
		...
		defer cancel()
		_, _ = cleanupClient.Delete(ctx, "/orbitjob/elections/"+prefix, clientv3.WithPrefix())
		_, _ = cleanupClient.Delete(ctx, "/orbitjob/locks/"+prefix, clientv3.WithPrefix())
	}

...
| `WORKER_CAPACITY_MAX` | Adaptive capacity ceiling | `10` |
| `WORKER_LEASE_MIN_SEC` | Dynamic lease floor (seconds) | `10` |
| `WORKER_LEASE_DURATION_MAX` | Dynamic lease ceiling (seconds) | `300` |
| `WORKER_LEASE_EMA_DECAY` | Dynamic lease EMA decay factor | `0.1` |
